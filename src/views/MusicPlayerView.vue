  ...
  <div class="relative h-[100vh] transition-container">
    <div class="absolute z-[3]">
      ...
      <div class="h-[15vw] w-[100vw] flex items-center px-[4vw] justify-between">
        <Icon icon="ep:arrow-up-bold" class="text-[6vw] mt-[0.6vw] text-[#fff]" :rotate="2"
        ...
        <div class="text-center">
          ...
          <p class="text-[2.8vw] text-[#BCBFBF] mt-[2vw] font-[400]"
            ...
            <span class="px-[1.6vw] py-[0.8vw] text-[#d8dBdB] text-[2vw] rounded-[1vw] bg-[#84868B] ml-[1vw]">关注</span>
          </p>
        </div>
      ...
      <!--胶片-->
      <div class="relative top-[2%] w-[100vw] h-[120vw]" v-if="!lyricsSwitching"
        ...
        <div class="w-[80vw] h-[80vw] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-45%]">
          <div class="absolute w-[80vw] h-[80vw]">
            <img src="/static/fang.png" alt="" class="absolute top-0 w-[80vw] h-[80vw]">
      ...
      <div class="fixed bottom-0">
        ...
        <!-- 下面播放控件 -->
        <div class="h-[12.3vw] flex w-[100vw] items-center justify-evenly mt-[13vw] mb-5">
          <div v-if="false">
          ...
          <div class="w-[12vw] h-[12vw] rounded-[50%] bg-[#fff] flex items-center justify-center">
            <Icon :icon="`${$player._playing ? 'carbon:pause-filled' : 'ph:play-fill'
              }`" width="20px" @click.native="playFn" />
          </div>
          <!--下一曲-->
    ...
    <van-popup class="rounded-t-[20px] px-[5.4vw]" v-model="show" position="bottom" :style="{ height: '60%' }">
      ...
      <div>
        <div v-for="(item, index) in music" :key="index.id" class="flex justify-between items-center h-[14vw]"
          ...
          <div class="flex items-center">
            <p class="text-[3vw] mr-[6vw] text-[#BCBCBC]" v-if="item.id === $player._currentTrack.id">
              播放来源
            </p>

  ...
  <div class="overflow-hidden">
    ...
    <van-sticky>
      <div class="flex items-center w-[100vw] h-[15vw] bg-[#fff]">
        <Icon icon="ph:arrow-left-light" color="#343434" width="8vw" @click.native="$router.push('/home')" class="ml-5" />
        <p class="text-[#2e2e2e] text-[5vw] ml-[5vw]">MV排行榜</p>
      </div>
    </van-sticky>
    <!-- tab切换 -->
    <van-tabs @click="changeTab" @change="changeTab" swipeable sticky offset-top="15vw">
          ...
          <li class="w-[91vw] mx-auto mt-[6vw]" v-for="(item, index) in MvList" :key="item.id"
            ...
            <div class="flex items-center mt-[5vw]">
              <div>
                ...
                <div class="flex items-center" v-if="item.lastRank < index + 1 && item.lastRank != -1">
                  <Icon icon="pepicons-pop:triangle-down-filled" class="text-[3vw] text-[green]" />
                  <div class="text-[2vw]">
